...
CXX_INCL=$(INCL:%=-I%)
PYCFLAGS= -I/usr/local/opt/python@3.9/Frameworks/Python.framework/Versions/3.9/include/python3.9
...
main: dist
	...
	@$(CXX) $(CXX_INCL) $(CXX_FLAGS) main.mm pystuff.mm cystuff/base.c MTC.cpp -o $(OUTPUT) -lpython3.9
	@echo "Finished"
dist:
	mkdir dist
clean: 
